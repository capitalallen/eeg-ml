...
class Data_prepare:
    def __inti__(self):
        pass 
    def convert_mat_np(self,gender=None,m_file=None,f_file=None):
    ...
    def combine_male_female(self,m_file,f_file):
        m = self.convert_mat_np("m",m_file,f_file)
        f = self.convert_mat_np("f",m_file,f_file)
...
# f_file = "./raw_data/Emotrans1_girl_data_preprocessed_42.mat"
# index=[40,41]
# df = test.combine_male_female(m_file,f_file)